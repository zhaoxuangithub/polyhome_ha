...
def setup_platform(hass, config, add_devices, discovery_info=None):
    ...
    def handle_event(event):
        ...
        if bytearr[0] == '0xa0' and bytearr[5] == '0x5':
        ...
        if bytearr[0] == '0xa0' and bytearr[5] == '0x5' and bytearr[8] == '0xcc':
            ...
            dev.heart_beat()
            if bytearr[13] == '0x1' and bytearr[14] == '0x0':
                dev.set_closed(False)
            if bytearr[13] == '0x1' and bytearr[14] == '0x1':
                dev.set_closed(True)
        if bytearr[0] == '0xc0':
